...
samplers_k_diffusion = [
    ...
    ('强文本细节模式-进阶 DPM++ SDE Karras', 'sample_dpmpp_sde', ['k_dpmpp_sde_ka'], {'scheduler': 'karras', "second_order": True, "brownian_noise": True}),
    ...
    ('柔和插画模式-进阶 Euler a', 'sample_euler_ancestral', ['k_euler_a', 'k_euler_ancestral'], {"uses_ensd": True}),
    ('柔和插画模式-景深 Euler', 'sample_euler', ['k_euler'], {}),
    ('低对比模式 LMS', 'sample_lms', ['k_lms'], {}),
    ('高步模式 Heun', 'sample_heun', ['k_heun'], {"second_order": True}),
    ('高文本模式 DPM2', 'sample_dpm_2', ['k_dpm_2'], {'discard_next_to_last_sigma': True, "second_order": True}),
    ('高文本模式-特写强化 DPM2 a', 'sample_dpm_2_ancestral', ['k_dpm_2_a'], {'discard_next_to_last_sigma': True, "uses_ensd": True, "second_order": True}),
    ('高文本插画模式 DPM++ 2S a', 'sample_dpmpp_2s_ancestral', ['k_dpmpp_2s_a'], {"uses_ensd": True, "second_order": True}),
    ('高文本插画模式-景深 DPM++ 2M', 'sample_dpmpp_2m', ['k_dpmpp_2m'], {}),
    ('高文本细节模式 DPM++ SDE', 'sample_dpmpp_sde', ['k_dpmpp_sde'], {"second_order": True, "brownian_noise": True}),
    ...
    ('高文本模式-快速 DPM fast', 'sample_dpm_fast', ['k_dpm_fast'], {"uses_ensd": True}),
    ('DPM adaptive', 'sample_dpm_adaptive', ['k_dpm_ad'], {"uses_ensd": True}),
    ('油画模式 LMS Karras', 'sample_lms', ['k_lms_ka'], {'scheduler': 'karras'}),
    ('强文本模式 DPM2 Karras', 'sample_dpm_2', ['k_dpm_2_ka'], {'scheduler': 'karras', 'discard_next_to_last_sigma': True, "uses_ensd": True, "second_order": True}),
    ('强文本模式-进阶 DPM2 a Karras', 'sample_dpm_2_ancestral', ['k_dpm_2_a_ka'], {'scheduler': 'karras', 'discard_next_to_last_sigma': True, "uses_ensd": True, "second_order": True}),
    ('强文本插画模式-进阶 DPM++ 2S a Karras', 'sample_dpmpp_2s_ancestral', ['k_dpmpp_2s_a_ka'], {'scheduler': 'karras', "uses_ensd": True, "second_order": True}),
