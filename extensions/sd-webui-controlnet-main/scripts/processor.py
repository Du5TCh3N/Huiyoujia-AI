...
preprocessor_filters = {
    "All": "none",
    "参考全身姿势 OpenPose": "openpose_full",
    "参考区块 Segmentation": "seg_ofade20k",
    "参考景深 Depth": "depth_midas",
    "参考轮廓-弱 Scribble/Sketch": "scribble_pidinet",
    "参考轮廓-中 SoftEdge": "softedge_pidinet",
    "参考轮廓-强Canny": "canny",
    "参考直线图 MLSD": "mlsd",
    "参考生成 Reference": "reference_only",
    "参考线稿 Lineart": "lineart_standard (from white bg & black line)",
    "超清重绘 Tile/Blur": "tile_resample",
